...
TEST(RNNTest, RNN_bidirectional_bias_initial_zigged_batch) {
  ...
  Vector<float> X_data_in_batchs{1.64644051F, 2.14556813F,
                                      ...
                                      0.0F, 0.0F,
                                      0.0F, 0.0F};
  Vector<float> X_data(seq_length * batch_size * input_size);
  MemoryLayoutTransposeRNNInputCNTKToONNXRuntime(&X_data_in_batchs[0], &X_data[0], seq_length, batch_size, input_size);
  test.AddInput<float>("X", X_dims, X_data);

  Vector<int64_t> W_dims = {num_directions, hidden_size, input_size};
  Vector<float> W_data({0.4317745F, 0.37378395F, -1.0386457F, -0.22681296F, 0.4418987F, 0.49973935F,
                             0.47248289F, -0.63369429F, 0.89542073F, 0.69698066F, 0.65118814F, 1.0828459F});
  test.AddInput<float>("W", W_dims, W_data);

  Vector<int64_t> R_dims = {num_directions, hidden_size, hidden_size};
  Vector<float> R_data({-0.24072374F, -0.29326528F, -0.91741192F,
  ...
  Vector<int64_t> B_dims = {num_directions, 2 * hidden_size};
  Vector<float> B_data({-0.44529742F, 0.80094892F, -1.0028138F, 0.0F, 0.0F, 0.0F,
  ...
  Vector<int> sequence_lens_data{5, 3};
  ...
  Vector<float> initial_h_data({1.2F, 1.2F, 1.2F, 1.2F, 1.2F, 1.2F, 1.2F, 1.2F, 1.2F, 1.2F, 1.2F, 1.2F});
  ...
  Vector<float> Y_data_in_batchs({-0.58767605F, 0.69586837F, -0.48001164F, -0.71697658F, 0.99646497F, 0.9980582F,
                                       ...
                                       0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F});
  Vector<float> Y_data(seq_length * num_directions * batch_size * hidden_size);
  ...
  Vector<float> Y_h_data({0.51060104F, -0.95055139F, -0.12672578F, -0.28076148F, -0.04275616F, -0.75480938F,
...
TEST(RNNTest, RNN_bidirectional_zigged_batch) {
  ...
  Vector<int64_t> W_dims = {num_directions, hidden_size, input_size};
  Vector<float> W_data({-0.68526405F, 0.3758406F, 0.13007233F, 0.6596455F, -0.68564546F, 0.22745803F,
                             0.37704858F, -0.075543992F, -0.92860377F, -0.014112951F, -1.0042796F, 0.83100969F});
  test.AddInput<float>("W", W_dims, W_data);

  Vector<int64_t> R_dims = {num_directions, hidden_size, hidden_size};
  Vector<float> R_data({0.22057047F, -0.25696567F, 0.93817306F,
  ...
  Vector<int64_t> B_dims = {num_directions, 2 * hidden_size};
  Vector<float> B_data({0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F});
  test.AddInput<float>("B", B_dims, B_data);
  ...
  Vector<int64_t> initial_h_dims = {num_directions, batch_size, hidden_size};
  Vector<float> initial_h_data({0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F});
  test.AddInput<float>("initial_h", initial_h_dims, initial_h_data);

  Vector<int64_t> Y_dims = {seq_length, num_directions, batch_size, hidden_size};
  Vector<float> Y_data_in_batchs({-0.31118321F, 0.92598617F, -0.56547648F, 0.39222997F, -0.99489242F, 0.86467457F,
  ...
  Vector<int64_t> Y_h_dims{num_directions, batch_size, hidden_size};
  Vector<float> Y_h_data({-0.85353446F, 0.34633741F, -0.93988168F, -0.79737622F, 0.62769204F, 0.30727068F,
...
TEST(RNNTest, RNN_reverse_direction_zigged_batch) {
  ...
  Vector<int64_t> X_dims = {seq_length, batch_size, input_size};
  Vector<float> X_data_in_batchs{0.54881352F, 0.71518934F,
  ...
  Vector<int64_t> W_dims = {num_directions, hidden_size, input_size};
  Vector<float> W_data({0.60482931F, 0.67304987F, 0.13166776F, -0.33417314F, 0.66345924F, -0.49411628F});
  test.AddInput<float>("W", W_dims, W_data);

  Vector<int64_t> R_dims = {num_directions, hidden_size, hidden_size};
  Vector<float> R_data({0.50877059F, 0.78382635F, 0.665046F,
                             0.89860243F, -0.71745688F, 0.80142093F,
                             -0.76517141F, -0.88981366F, -0.48568386F});
  test.AddInput<float>("R", R_dims, R_data);

  Vector<int64_t> B_dims = {num_directions, 2 * hidden_size};
  Vector<float> B_data({0.0F, 0.0F, 0.0F,
                             0.0F, 0.0F, 0.0F});
  test.AddInput<float>("B", B_dims, B_data);
  ...
  Vector<int64_t> initial_h_dims = {num_directions, batch_size, hidden_size};
  Vector<float> initial_h_data({0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F});
  test.AddInput<float>("initial_h", initial_h_dims, initial_h_data);

  Vector<int64_t> Y_dims = {seq_length, num_directions, batch_size, hidden_size};
  Vector<float> Y_data_in_batchs({0.87014002F, 0.09402763F, -0.54269236F,
  ...
  Vector<int64_t> Y_h_dims{num_directions, batch_size, hidden_size};
  Vector<float> Y_h_data({0.87014002F, 0.09402763F, -0.54269236F, 0.64809889F, -0.19472955F, -0.24271242F});
  test.AddOutput<float>("Y_h", Y_h_dims, Y_h_data);
...
TEST(RNNTest, RNN_forward_direction_zigged_batch) {
  ...
  Vector<int64_t> X_dims = {seq_length, batch_size, input_size};
  Vector<float> X_data_in_batchs{0.061169811F, 0.26296741F,
  ...
  Vector<int64_t> W_dims = {num_directions, hidden_size, input_size};
  Vector<float> W_data({-0.49937296F, -0.082866333F, 0.40978807F, -0.33496389F, -0.40066367F, -0.72275674F});
  test.AddInput<float>("W", W_dims, W_data);

  Vector<int64_t> R_dims = {num_directions, hidden_size, hidden_size};
  Vector<float> R_data({0.16146433F, -0.36291042F, 0.61149812F,
  ...
  Vector<int64_t> Y_dims = {seq_length, num_directions, batch_size, hidden_size};
  Vector<float> Y_data_in_batchs({-0.0522899628F, -0.0629346371F, -0.211336553F,
  ...
  Vector<int64_t> Y_h_dims{num_directions, batch_size, hidden_size};
  Vector<float> Y_h_data({-0.746264696F, -0.0781838298F, -0.751394153F, -0.343922496F, -0.181868196F, -0.130254388F});
  test.AddOutput<float>("Y_h", Y_h_dims, Y_h_data);
...
TEST(RNNTest, RNN_bidirectional_0) {
  ...
  Vector<int64_t> X_dims = {seq_length, batch_size, input_size};
  Vector<float> X_data({0.54881352F, 0.71518934F,
                             0.60276335F, 0.54488319F,
                             0.42365479F, 0.64589411F,
  ...
  Vector<int64_t> W_dims = {num_directions, hidden_size, input_size};
  Vector<float> W_data({-0.74535543F, 0.21360011F, 1.0782362F, 0.092641734F, -1.0087538F, -0.97021431F,
                             0.88425213F, 0.93182313F, 0.767329F, -0.541361F, 0.6218195F, -0.7977342F});

  test.AddInput<float>("W", W_dims, W_data);

  Vector<int64_t> R_dims = {num_directions, hidden_size, hidden_size};
  Vector<float> R_data({// forward
  ...
  Vector<int64_t> B_dims = {num_directions, 2 * hidden_size};
  Vector<float> B_data({0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F,
                             0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F});
  test.AddInput<float>("B", B_dims, B_data);

  Vector<int64_t> sequence_lens_dims({batch_size});
  Vector<int> sequence_lens_data(batch_size, (int)seq_length);
  test.AddInput<int>("sequence_lens", sequence_lens_dims, sequence_lens_data);
  ...
  Vector<int64_t> Y_dims = {seq_length, num_directions, batch_size, hidden_size};
  Vector<float> Y_data({-0.25082839F, 0.57703555F, -0.84758246F, 0.89708149F, -0.50691134F, 0.10560472F,
  ...
  Vector<int64_t> Y_h_dims{num_directions, batch_size, hidden_size};
  Vector<float> Y_h_data({-0.74539614F, 0.93210655F, -0.63887376F, 0.89708149F, -0.50691134F, 0.10560472F});
  test.AddOutput<float>("Y_h", Y_h_dims, Y_h_data);
...
TEST(RNNTest, RNN_bidirectional_1) {
  ...
  Vector<int64_t> X_dims = {seq_length, batch_size, input_size};
  Vector<float> X_data({1.0F, 1.0F});

  test.AddInput<float>("X", X_dims, X_data);

  Vector<int64_t> W_dims = {num_directions, hidden_size, input_size};
  Vector<float> W_data({1.0F, 1.0F, 1.0F, 1.0F,
                             1.0F, 1.0F, 1.0F, 1.0F});
  ...
  Vector<int64_t> B_dims = {num_directions, 2 * hidden_size};
  Vector<float> B_data({0.0F, 0.0F, 0.0F, 0.0F,
                             0.0F, 0.0F, 0.0F, 0.0F});
  test.AddInput<float>("B", B_dims, B_data);
  ...
  Vector<int64_t> initial_h_dims = {num_directions, batch_size, hidden_size};
  Vector<float> initial_h_data({0.1F, 0.2F, 0.3F, 0.4F});
  test.AddInput<float>("initial_h", initial_h_dims, initial_h_data);

  Vector<int64_t> Y_dims = {seq_length, num_directions, batch_size, hidden_size};
  Vector<float> Y_data({0.98009639F, 0.98009639F, 0.99100745F, 0.99100745F});
  test.AddOutput<float>("Y", Y_dims, Y_data);

  Vector<int64_t> Y_h_dims{num_directions, batch_size, hidden_size};
  Vector<float> Y_h_data({0.98009639F, 0.98009639F, 0.99100745F, 0.99100745F});
  test.AddOutput<float>("Y_h", Y_h_dims, Y_h_data);
...
TEST(RNNTest, DISABLED_RNN_default_attributes_and_forward_direction) {
  ...
  auto run_test = [&](OpTester& test, bool useDefault, RNNOutputOption outputOption) {
    Vector<int64_t> X_dims = {seq_length, batch_size, input_size};
    Vector<float> X_data({0.061169811F, 0.26296741F,
                               0.80939841F, 0.080034949F,
                               0.21000224F, 0.65772671F,
                               0.20081005F, 0.95461535F,
                               0.93818879F, 0.76034665F});
    ...
    if (useDefault) {
      ...
      Vector<int64_t> initial_h_dims = {num_directions, batch_size, hidden_size};
      Vector<float> initial_h_data({0.0F, 0.0F, 0.0F});
      test.AddInput<float>("initial_h", initial_h_dims, initial_h_data);
    } else {
    ...
    if (outputOption == RNNOutputY || outputOption == RNNOutputBoth) {
      Vector<int64_t> Y_dims = {seq_length, num_directions, batch_size, hidden_size};
      Vector<float> Y_data({-0.052289959F, -0.062934637F, -0.21133657F,
    ...
    if (outputOption == RNNOutputY_h || outputOption == RNNOutputBoth) {
      Vector<int64_t> Y_h_dims{num_directions, batch_size, hidden_size};
      Vector<float> Y_h_data({-0.74626476F, -0.07818383F, -0.75139415F});
      test.AddOutput<float>("Y_h", Y_h_dims, Y_h_data);
    } else {
      test.AddMissingOptionalOutput<float>();
    }
...
TEST(RNNTest, DISABLED_RNN_reverse_direction) {
  ...
  auto runTest = [&](OpTester& test, bool useDefault, RNNOutputOption outputOption) {
    ...
    Vector<int64_t> R_dims = {num_directions, hidden_size, hidden_size};
    Vector<float> R_data({-0.7322467F, -0.95795155F, -0.058495734F,
                               -0.7271859F, -0.29820377F, -0.85114992F,
                               -0.097570196F, 0.82271612F, 0.1396943F});
    test.AddInput<float>("R", R_dims, R_data);
    ...
    Vector<int64_t> Y_dims = {seq_length, num_directions, batch_size, hidden_size};
    Vector<float> Y_data({-0.55397642F, 0.83026606F, -0.51471221F,
    ...
    Vector<int64_t> Y_h_dims{num_directions, batch_size, hidden_size};
    Vector<float> Y_h_data({-0.55397642F, 0.83026606F, -0.51471221F});
    if (outputOption == RNNOutputY_h || outputOption == RNNOutputBoth) {
      test.AddOutput<float>("Y_h", Y_h_dims, Y_h_data);
    } else {
      test.AddMissingOptionalOutput<float>();
...
TEST(RNNTest, RNN_invalid_sequence_lens) {
  ...
  auto run_test = [&](const Vector<int>& sequence_lens,
    ...
    Vector<int64_t> X_dims = {seq_length, batch_size, input_size};
    Vector<float> X_data({0.1f, 0.2f, 0.3f,
                               0.4f, 0.5f, 0.6f,
                               0.7f, 0.8f, 0.9f,
                               0.11f, 0.12f, 0.13f});
    ...
    Vector<int64_t> W_dims = {num_directions, hidden_size, input_size};
    Vector<float> W_data({-0.1f, 0.2f, 1.f, -2.f, -1.f, 3.f});

    test.AddInput<float>("W", W_dims, W_data);

    Vector<int64_t> R_dims = {num_directions, hidden_size, hidden_size};
    Vector<float> R_data({0.f, 0.f, 0.f,
                               0.f, 0.f, 0.f,
                               0.f, 0.f, 0.f});
    test.AddInput<float>("R", R_dims, R_data);

    Vector<int64_t> B_dims = {num_directions, 2 * hidden_size};
    Vector<float> B_data{0.f, 0.f, 0.f, 0.f, 0.f, 0.f};
    test.AddInput<float>("B", B_dims, B_data);

    // Vector<int64_t> sequence_lens_dims({batch_size});
    Vector<int64_t> sequence_lens_dims{gsl::narrow_cast<int64_t>(sequence_lens.size())};
    test.AddInput<int>("sequence_lens", sequence_lens_dims, sequence_lens);

    Vector<int64_t> initial_h_dims = {num_directions, batch_size, hidden_size};
    Vector<float> initial_h_data{0.f, 0.f, 0.f, 0.f, 0.f, 0.f};
    test.AddInput<float>("initial_h", initial_h_dims, initial_h_data);
    ...
    Vector<int64_t> Y_h_dims{num_directions, batch_size, hidden_size};
    Vector<float> Y_h_data{0.f, 0.f, 0.f, 0.f, 0.f, 0.f};
    test.AddOutput<float>("Y_h", Y_h_dims, Y_h_data);
...
TEST(RNNTest, RNN_bidirectional_with_sequence_lens) {
  ...
  Vector<int64_t> R_dims = {num_directions, hidden_size, hidden_size};
  Vector<float> R_data{0.1f, 0.1f, 0.1f, 0.1f,
                            0.1f, 0.1f, 0.1f, 0.1f,
                            0.1f, 0.1f, 0.1f, 0.1f,
                            0.1f, 0.1f, 0.1f, 0.1f,
                            0.2f, 0.2f, 0.2f, 0.2f,
  ...
  Vector<int64_t> B_dims = {num_directions, 2 * hidden_size};
  Vector<float> B_data{0.1f, 0.1f, 0.1f, 0.1f, 0.1f, 0.1f, 0.1f, 0.1f,
                            0.1f, 0.1f, 0.1f, 0.1f, 0.1f, 0.1f, 0.1f, 0.1f};
  test.AddInput<float>("B", B_dims, B_data);

  Vector<int64_t> sequence_lens_dims{batch_size};
  Vector<int> sequence_len_data{1, 2, 2};
  ...
  Vector<int64_t> Y_h_dims{num_directions, batch_size, hidden_size};
  Vector<float> Y_h_data{0.69999999f, 1.3000001f, 1.9000001f, 1.9000001f,
                              2.6200001f, 4.2200003f, 5.8199997f, 5.8199997f,
                              3.2600002f, 5.0600004f, 6.8600001f, 6.8600001f,
