...
TEST(MLOpTest, SVMRegressorSVC) {
  ...
  Vector<float> predictions = {1.40283655f, 1.86065906f, 2.66064161f, 1.96311014f, 1.96311014f, 1.96292297f, 1.96311014f, 3.78978065f};
...
TEST(MLOpTest, SVMRegressorNuSVC) {
  ...
  //three estimates, for 3 points each, so 9 predictions
  Vector<float> X = {1.f, 0.0f, 0.4f, 3.0f, 44.0f, -3.f, 12.0f, 12.9f, -312.f, 23.0f, 11.3f, -222.f, 23.0f, 11.3f, -222.f, 23.0f, 3311.3f, -222.f, 23.0f, 11.3f, -222.f, 43.0f, 413.3f, -114.f};
  Vector<float> predictions = {1.51230766f, 1.77893206f, 2.75948633f, 1.96944663f, 1.96944663f, 1.96923464f, 1.96944663f, 3.88948633f};
...
TEST(MLOpTest, SVMRegressorNuSVCPolyKernel) {
  ...
  //three estimates, for 3 points each, so 9 predictions
  Vector<float> X = {1.f, 0.0f, 0.4f, 3.0f, 44.0f, -3.f, 12.0f, 12.9f, -312.f, 23.0f, 11.3f, -222.f, 23.0f, 11.3f, -222.f, 23.0f, 3311.3f, -222.f, 23.0f, 11.3f, -222.f, 43.0f, 413.3f, -114.f};
  Vector<float> predictions = {1.50041863e+00f, 3.49624795e-01f, 2.75850969e+00f, -2.28659294e+02f, -2.28659294e+02f, -6.09640826e+05f, -2.28659294e+02f, 3.89055773e+00f};
...
TEST(MLOpTest, SVMRegressorLinear) {
  ...
  //three estimates, for 3 points each, so 9 predictions
  Vector<float> X = {1.f, 0.0f, 0.4f, 3.0f, 44.0f, -3.f, 12.0f, 12.9f, -312.f, 23.0f, 11.3f, -222.f, 23.0f, 11.3f, -222.f, 23.0f, 3311.3f, -222.f, 23.0f, 11.3f, -222.f, 43.0f, 413.3f, -114.f};
  Vector<float> predictions = {1.52992759f, 0.8661395f, -0.93420165f, 3.72777548f, 3.72777548f, -84.22117216f, 3.72777548f, 0.48095091f};
