...
const Vector<float> ComputeGelu(const Vector<float>& input_data) {
  Vector<float> output;
...
const Vector<float> AddBias(const Vector<float>& input_data, const Vector<float>& bias_data) {
...
const Vector<float> GetExpectedResult(const Vector<float>& input_data, const Vector<float>& bias_data) {
  Vector<float> add_bias_data = AddBias(input_data, bias_data);
...
static void RunFastGeluTest(
    ...
    const Vector<int64_t>& bias_dims,
...
static void RunFastGeluTest(
  ...
  Vector<int64_t> bias_dims = {hidden_size};
