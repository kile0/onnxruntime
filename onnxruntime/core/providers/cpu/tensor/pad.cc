...
static void FlattenInnerShape(const Vector<int64_t>& input_dims, const std::vector<int64_t>& pads,
                              const std::vector<int64_t>& slices,Vector<int64_t>& reshaped_dims) {
