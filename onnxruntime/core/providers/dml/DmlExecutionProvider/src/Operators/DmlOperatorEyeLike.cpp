...
public:
    ...
    :   DmlOperator(kernelCreationContext)
    {
        ...
        Vector<std::optional<uint32_t>> inputIndices = {}; // Ignore the 1st input tensor for the GPU.
        ...
        Vector<DimensionType> outputDimensions = outputTensorShapeDescription.GetOutputTensorShape(0);
