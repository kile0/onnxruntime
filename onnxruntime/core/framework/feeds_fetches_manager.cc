...
common::Status FeedsFetchesInfo::MapNamesToMLValueIdxs(const Vector<std::string>& names,
...
Status FeedsFetchesManager::Create(const Vector<std::string>& feed_names,
